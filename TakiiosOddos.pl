##Takiios##
##Optimal Perl##
# DDoS Script Opti by Taki , Owner code by SamY , cqHack number 1 :D
...
if ($help || !$ip) {
  print <<'EOL';
 The usage of command is perl by Samy Opti by Taki cqHack Number one
EOL
  exit(1);
}
...
printf "[0;32m>> Opti by Taki Owner Code SamY , cqHack  \n";
printf "[0;32m>>Rekt by Taki  \n";
